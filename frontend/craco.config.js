...
webpackConfig.devServer = (devServerConfig) => {
  // Strip deprecated APIs removed in webpack-dev-server v5 (react-scripts 5.0.1 still injects them)
  if (devServerConfig.onBeforeSetupMiddleware || devServerConfig.onAfterSetupMiddleware) {
    ...
    devServerConfig.setupMiddlewares = (middlewares, devServer) => {
      ...
      const result = originalSetup ? originalSetup(middlewares, devServer) : middlewares;
  ...
  if (Object.prototype.hasOwnProperty.call(devServerConfig, "https")) {
    ...
    if (httpsVal) {
      devServerConfig.server = typeof httpsVal === "object" ? { type: "https", options: httpsVal } : "https";
    }
  }
